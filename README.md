...
- The [main](https://github.com/RHsyseng/operator-utils/tree/main) (default) branch supports **OCP 4.14** (K8S 1.27)
...
- To contribute features targeting **OCP 4.14** only, use a local feature branch based off of & targeting `origin/main` with any PR's, Reference any JIRA/GitHub issues in PR's where applicable.
